...
# CATM Threshold: 0.5 | GPU: 1x RTX 5090
# =============================================================
...
LR=0.0001
STEPS="(18000,24000)"
OUTPUT_DIR="/root/autodl-tmp/penet2/checkpoints/finetune_stsgg_high"
MODEL_NAME="Exp-B-STSGG-thresh0.5"
...
echo ""
echo "[START] CATM threshold=0.5, 训练开始: $(date)"
echo "============================================="
echo ""
