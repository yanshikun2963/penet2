...
# CATM Threshold: 0.4 | GPU: 1x RTX 5090
# =============================================================
...
LR=0.0001
STEPS="(18000,24000)"
OUTPUT_DIR="/root/autodl-tmp/penet2/checkpoints/finetune_stsgg_default"
MODEL_NAME="Exp-B-STSGG-thresh0.4"
...
echo ""
echo "[START] CATM threshold=0.4, 训练开始: $(date)"
echo "============================================="
echo ""
